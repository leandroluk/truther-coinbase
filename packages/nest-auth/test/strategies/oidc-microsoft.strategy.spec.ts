import {OidcMicrosoftStrategy} from '#/strategies';
...
const makeSut = async () => {
  ...
  const sut = new OidcMicrosoftStrategy(authEnv as any, databaseService as any, cacheService as any);
  return {req, profile, authEnv, databaseService, cacheService, sut};
};

describe('strategies/oidc-microsoft.strategy', () => {
  describe('validate', () => {
